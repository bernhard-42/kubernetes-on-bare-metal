...
Heketi client needs to be the same version as on the kubernetes cluster
    ...
    tar -zxvf heketi-client-v8.0.0.darwin.amd64.tar.gz
...
- Delete Operator
        ...
        kubectl delete crd clusters.ceph.rook.io filesystems.ceph.rook.io objectstores.ceph.rook.io pools.ceph.rook.io volumes.rook.io
        kubectl delete clusterrole rook-ceph-cluster-mgmt rook-ceph-global
        kubectl delete clusterrolebindings rook-ceph-global
